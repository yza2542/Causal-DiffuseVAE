...
from util_1 import configure_device, get_dataset, get_celeba_data
...
def load_dataset(dataset_dir):
    ...
    train_dataset, val_dataset, test_dataset, train_loader, val_loader, test_loader = \
        get_celeba_data(dataset_dir, 1, type='train')
...
def generate_recons(config):
    ...
    dataset_dir = '/home/2527823Y/DiffuseVAE-main/main/datasets/celeba64/'
