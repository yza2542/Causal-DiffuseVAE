python generate_recons.py +dataset=smile_A/test \
                         dataset.ddpm.data.root='/home/2527823Y/DiffuseVAE-main/main/datasets/celeba64' \
                         dataset.ddpm.data.name='smile' \
                         ...
                         dataset.ddpm.evaluation.chkpt_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoints_lastversion/ddpmv1-smile_rework_form1__2ndMay_sota_nheads=8_dropout=0.1-epoch=499-loss=0.0124.ckpt\' \
                         ...
                         dataset.ddpm.evaluation.save_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/test_ddpm/\' \
...
#python generate_inference.py +dataset=smile_A/test \
#                         dataset.ddpm.data.root='/home/2527823Y/DiffuseVAE-main/main/datasets/smile64' \
#                         dataset.ddpm.data.name='smile' \
#                         dataset.ddpm.data.norm=False \
#                         dataset.ddpm.data.hflip=False \
#                         dataset.ddpm.model.attn_resolutions=\'16,\' \
...
#                         dataset.ddpm.evaluation.device=\'gpu:1\' \
#                         dataset.ddpm.evaluation.save_mode='image' \
#                         dataset.ddpm.evaluation.chkpt_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoints_lastversion/ddpmv1-smile_rework_form1__2ndMay_sota_nheads=8_dropout=0.1-epoch=196-loss=0.0106.ckpt\' \
#                         dataset.ddpm.evaluation.type='form1' \
#                         dataset.ddpm.evaluation.resample_strategy='spaced' \
#                         dataset.ddpm.evaluation.skip_strategy='quad' \
#                         dataset.ddpm.evaluation.sample_method='ddpm' \
...
#                         dataset.ddpm.evaluation.temp=1.0 \
#                         dataset.ddpm.evaluation.batch_size=4 \
#                         dataset.ddpm.evaluation.save_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/inference/\' \
#                         dataset.ddpm.evaluation.z_cond=False \
#                         dataset.ddpm.evaluation.n_samples=1000 \
#                         dataset.ddpm.evaluation.n_steps=1000 \
#                         dataset.ddpm.evaluation.save_vae=True \
