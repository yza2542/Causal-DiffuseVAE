...
class DagLayer(nn.Linear):
    def __init__(self, in_features, out_features, i=False, bias=False):
        ...
        # self.a[1, 2:4] = 1
        # self.a[1, 3] = 1 #flow
        # self.a[2, 3], self.a[0, 2] = 1, 1 #flow
        # self.a[1, 2], self.a[3, 2] = 1, 1
        # self.a[0, 2], self.a[1, 3] = 1, 1
        # self.a[0, 0], self.a[1, 1], self.a[2, 2], self.a[3, 3] = 1, 1, 1, 1
        # self.a[0, 1], self.a[1, 2], self.a[3, 2] = 1, 1, 1
        # self.a[0, 2], self.a[1, 3], self.a[2, 3] = 1, 1, 1
        #self.a[2, 0], self.a[2, 1], self.a[3, 0], self.a[1, 0], self.a[3, 1], self.a[3, 2] = 0.5, 0.5, 0.5, 0.5, 0.5, 0.5
        # self.a[1, 0] = 1
        # self.a[0, 1] = 1
    ...
    def mask_z(self, x, i):
        ...
        x = torch.mul((self.A + self.I)[:, i].reshape(3, 1).clone(), x.clone())
        # x = torch.mul((self.A + self.I)[:, i].reshape(4, 1).clone(), x.clone())
        # x = torch.mul((self.A + self.I)[:, i].reshape(2, 1).clone(), x.clone())
        # print(x.size())
