python generate_inference.py +dataset=shadow/test \
                         dataset.ddpm.data.root='/home/2527823Y/DiffuseVAE-main/main/datasets/Shadow_Do' \
                         dataset.ddpm.data.name='shadow' \
                         ...
                         dataset.ddpm.evaluation.chkpt_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoint_shadow_Do/ddpm/checkpoints/ddpmv2_-smile_rework_form1__2ndMay_sota_nheads=8_dropout=0.1-epoch=999-loss=0.0001.ckpt\' \
                         dataset.ddpm.evaluation.type='form2' \
                         dataset.ddpm.evaluation.mask=0 \
                         dataset.ddpm.evaluation.value=0.6\
                         ...
                         dataset.ddpm.evaluation.save_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/shadow0_0.6\' \
