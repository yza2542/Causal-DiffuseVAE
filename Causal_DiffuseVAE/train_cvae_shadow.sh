python train_cvae_shadow.py +dataset=shadow/train \
                      dataset.vae.data.root='/home/2527823Y/DiffuseVAE-main/main/datasets/Shadow_RGBA' \
                      dataset.vae.data.name='shadow' \
                      dataset.vae.training.batch_size=64 \
                      dataset.vae.training.dataset_dir='/home/2527823Y/DiffuseVAE-main/main/datasets/Shadow_RGBA' \
                      dataset.vae.training.epochs=100 \
                      dataset.vae.training.device=\'gpu:0\' \
                      dataset.vae.training.results_dir=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoint_shadow_RGBA\' \
