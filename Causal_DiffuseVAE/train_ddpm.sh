...
# # CelebA-64 (Form-1)
#python train_ddpm.py +dataset=Mnist/train \
#                      dataset.ddpm.data.root='/main/datasets/mnist/train-images-idx3-ubyte.gz' \
#                      dataset.ddpm.data.name='Mnist' \
#                      dataset.ddpm.data.norm=True \
...
#                      dataset.ddpm.model.attn_resolutions=\'16,\' \
#                      dataset.ddpm.model.n_residual=2 \
#                      dataset.ddpm.model.dim_mults=\'1,2,2\' \
#                      dataset.ddpm.model.n_heads=8 \
#                      dataset.ddpm.training.dataset_dir='/main/datasets/mnist/train-images-idx3-ubyte.gz' \
#                      dataset.ddpm.training.type='form2' \
#                      dataset.ddpm.training.cfd_rate=0.0 \
#                      dataset.ddpm.training.epochs=1000 \
#                      dataset.ddpm.training.z_cond=False \
#                      dataset.ddpm.training.batch_size=16 \
#                      dataset.ddpm.training.cvae_chkpt_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoint_mnist/checkpoints/vae_celeba_128-celeba64_alpha=1.0-epoch=99-train_loss=0.0000.ckpt\' \
#                      dataset.ddpm.training.device=\'gpu:0\' \
#                      dataset.ddpm.training.results_dir=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoint_mnist/ddpm/\' \
#                      dataset.ddpm.training.workers=1 \
#                      dataset.ddpm.training.chkpt_prefix=\'smile_rework_form1__2ndMay_sota_nheads=8_dropout=0.1\'
...
python train_ddpm.py +dataset=shadow/train \
                      dataset.ddpm.data.root='/home/2527823Y/DiffuseVAE-main/main/datasets/Shadow_Do' \
                      dataset.ddpm.data.name='Mnist' \
                      dataset.ddpm.data.norm=True \
                      dataset.ddpm.data.hflip=False \
                      dataset.ddpm.model.dim=128 \
                      ...
                      dataset.ddpm.model.n_heads=8 \
                      dataset.ddpm.training.dataset_dir='/home/2527823Y/DiffuseVAE-main/main/datasets/Shadow_Do' \
                      dataset.ddpm.training.type='form2' \
                      dataset.ddpm.training.cfd_rate=0.0 \
                      dataset.ddpm.training.epochs=1000 \
                      dataset.ddpm.training.z_cond=False \
                      dataset.ddpm.training.batch_size=16 \
                      dataset.ddpm.training.cvae_chkpt_path=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoint_shadow_Do/checkpoints/vae_celeba_128-celeba64_alpha=1.0-epoch=99-train_loss=0.0000.ckpt\' \
                      dataset.ddpm.training.device=\'gpu:0\' \
                      dataset.ddpm.training.results_dir=\'/home/2527823Y/DiffuseVAE-main/main/datasets/causal_result/checkpoint_shadow_Do/ddpm/\' \
                      dataset.ddpm.training.workers=1 \
                      dataset.ddpm.training.chkpt_prefix=\'smile_rework_form1__2ndMay_sota_nheads=8_dropout=0.1\'